...
//!!!
        mousePos.z = 5; // z Koordinate von Mauspos setzen
...
//!!!
            Instantiate(edge, new Vector3(pos.x, 5, pos.z), aimRotation); // Erstellen der Kante (edge aus Prefab, von Mittelpunkt 
